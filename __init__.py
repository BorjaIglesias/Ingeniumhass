...
from .const import DOMAIN, PLATFORMS  # Añade PLATFORMS aquí
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry):
    ...
    # Configuración de conexión (mantenido igual)
    ...
    # Único cambio requerido para 2025.6+
